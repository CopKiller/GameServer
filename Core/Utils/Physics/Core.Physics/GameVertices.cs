...
public class GameVertices : List<Vector2>
{
    ...
    public GameVertices(int capacity) : base(capacity)
    {
    }

    public GameVertices(IEnumerable<Vector2> vertices)
    {
        AddRange(vertices);
    }
    ...
    public void Translate(ref Vector2 value)
    {
        ...
        {
            foreach (GameVertices hole in Holes)
            {
